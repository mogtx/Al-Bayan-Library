...
const translations = {
  ar: {
    ...
    testimonial1: "مكتبة رائعة جداً توفر أفضل الكتب العربية. أنصح بها لكل محب للثقافة.",
    testimonial1Author: "كريم الساحوري",
    testimonial1AuthorAvatar: "ع",
    testimonial2: "تجربة مميزة جداً، التصميم الاحترافي يسهل التصفح والقراءة.",
    testimonial2Author: "خالد سعيد",
    testimonial2AuthorAvatar: "خ",
    ...
    aboutDesc: "نشأت هذه المكتبة استجابةً لإعلان وزارة التربية والتعليم عن مسابقة 'أفضل مدرسة داعمة للغة العربية' تحت عنوان 'صوت الضاد'، وذلك بهدف إبراز مكانة اللغة العربية وتعزيز حضورها بين الطلبة بأساليب إبداعية ومعاصرة.",
    aboutDesc2: "وقد تم إعداد وتصميم هذا الموقع بواسطة الطالب محمد مصطفى شومان و بإشراف مدرسة خالد بن الوليد الثانوية للبنين / لواء الموقر، ليكون منصة تعليمية تجمع بين المعرفة والمتعة، وتقدم محتوى متنوعًا في مجالات اللغة العربية من معاجم وشعر وقصص ونحو وبلاغة، بما يسهم في خدمة لغتنا الجميلة وترسيخ حبها في نفوس الطلبة.",
  ...
  en: {
    ...
    testimonial1: "A wonderful library that provides the best Arabic books. I recommend it to every culture lover.",
    testimonial1Author: "Karim Al-Sahouri",
    testimonial1AuthorAvatar: "K",
    testimonial2: "A very distinguished experience, the professional design makes browsing and reading easy.",
    testimonial2Author: "Khalid Saeed",
    testimonial2AuthorAvatar: "K",
    ...
    // Common
    copyright: "National Cultural Project",
    supervisedBySchool: "Supervised by Khalid ibn Al-Walid Secondary School / Al-Muwaqqar",
  }
};
